...
function renderReinForm() {
  ...
  const data = {
    ...
    antigram: {
      ...
      "Teicoplanine": {charge:"12mg/kg/12h pour 3 à 5 injections",">120":"12mg/kg/24h (C. continue 20–25mg/L)","30-120":"12mg/kg/24h (C. continue 20–25mg/L)","30-10":"4mg/kg/24h (C. continue 20–25mg/L)","<10":"4mg/kg/24h (C. continue 20–25mg/L)","hd":"4mg/kg/24h (C. résiduelle 20–25mg/L)","cvvh":"6–8 mg/kg/24h (C. continue 20–25mg/L)","cvvhd":"6–8 mg/kg/24h (C. continue 20–25mg/L)"}, // :contentReference[oaicite:37]{index=37}
...
function renderModalitesForm() {
  ...
  const MODALITES = {
    ...
    // ========= β-lactamines =========
    betalactamine: {
      "Amoxicilline":             { dosages:"2g", solvant:"Glucosé 5%", charge:{schema:"2g dans 50mL sur 30min"}, entretien:{rythme:"Perfusion intermittente", intervalle:"", doses:"", volume:"", perfusion:"", stabilite:""} },
      "Cloxacilline":             { dosages:"1g", solvant:"Glucosé 5%", charge:{schema:"2g dans 50mL sur 30min"}, entretien:{rythme:"Perfusion continue", intervalle:"", doses:"", volume:"", perfusion:"", stabilite:""} },
      "Oxacilline":               { dosages:"1g", solvant:"Glucosé 5%", charge:{schema:"2g dans 50mL sur 30min"}, entretien:{rythme:"Perfusion continue", intervalle:"", doses:"", volume:"", perfusion:"", stabilite:""} },
      "Amoxicilline + Clavulanate":{ dosages:"1g+0,1g ou 2g+0,2g", solvant:"Eau PPI", charge:{schema:"2g dans 50mL sur 30min"}, entretien:{rythme:"Perfusion intermittente", intervalle:"", doses:"", volume:"", perfusion:"", stabilite:""} },
      "Pipéracilline":            { dosages:"4g", solvant:"Glucosé 5%", charge:{schema:"4g dans 50mL sur 30min"}, entretien:{rythme:"Perfusion continue", intervalle:"", doses:"", volume:"", perfusion:"", stabilite:""} },
      "Pipéracilline + Tazobactam":{ dosages:"4g+0,5g", solvant:"Glucosé 5%", charge:{schema:"4g+0,5g dans 50mL sur 30min"}, entretien:{rythme:"Perfusion continue", intervalle:"", doses:"", volume:"", perfusion:"", stabilite:""} },
      "Céfazoline":               { dosages:"1g ou 2g", solvant:"Glucosé 5%", charge:{schema:"2g dans 50mL sur 30min"}, entretien:{rythme:"Perfusion continue", intervalle:"", doses:"", volume:"", perfusion:"", stabilite:""} },
      "Céfotaxime":               { dosages:"1g ou 2g", solvant:"Eau PPI", charge:{schema:"2g dans 50mL sur 30min"}, entretien:{rythme:"Perfusion intermittente", intervalle:"", doses:"", volume:"", perfusion:"", stabilite:""} },
      "Ceftriaxone":              { dosages:"1g ou 2g", solvant:"Eau PPI", charge:{schema:"2g dans 50mL sur 30min"}, entretien:{rythme:"Perfusion intermittente", intervalle:"", doses:"", volume:"", perfusion:"", stabilite:""} },
      "Ceftazidime":              { dosages:"1g ou 2g", solvant:"Glucosé 5%", charge:{schema:"2g dans 50mL sur 30min"}, entretien:{rythme:"Perfusion continue", intervalle:"", doses:"", volume:"", perfusion:"", stabilite:""} },
      "Céfépime":                 { dosages:"1g ou 2g", solvant:"Glucosé 5%", charge:{schema:"2g dans 50mL sur 30min"}, entretien:{rythme:"Perfusion continue", intervalle:"", doses:"", volume:"", perfusion:"", stabilite:""} },
      "Ceftobiprole":             { dosages:"500mg", solvant:"NaCl 0,9%", charge:{schema:"Pas de dose de charge"}, entretien:{rythme:"Perfusion intermittente", intervalle:"", doses:"", volume:"", perfusion:"", stabilite:""} },
      "Ceftaroline":              { dosages:"600mg", solvant:"Eau PPI", charge:{schema:"Pas de dose de charge"}, entretien:{rythme:"Perfusion intermittente", intervalle:"", doses:"", volume:"", perfusion:"", stabilite:""} },
      "Ceftazidime + Avibactam":  { dosages:"2g+0,5g", solvant:"Eau PPI", charge:{schema:"2g dans 50mL sur 2h"}, entretien:{rythme:"Perfusion continue", intervalle:"", doses:"", volume:"", perfusion:"", stabilite:""} },
      "Ceftolozane + Tazobactam": { dosages:"1g+0,5g", solvant:"Eau PPI", charge:{schema:"2g dans 50mL sur 30min"}, entretien:{rythme:"Perfusion continue", intervalle:"", doses:"", volume:"", perfusion:"", stabilite:""} },
      "Cefidérocol":              { dosages:"1g", solvant:"NaCl 0,9%", charge:{schema:"Pas de dose de charge"}, entretien:{rythme:"Perfusion intermittente", intervalle:"", doses:"", volume:"", perfusion:"", stabilite:""} },
      "Imipénème":                { dosages:"1g", solvant:"Glucosé 5%", charge:{schema:"2g dans 500mL sur 60min"}, entretien:{rythme:"Perfusion intermittente", intervalle:"", doses:"", volume:"", perfusion:"", stabilite:""} },
      "Méropénème":               { dosages:"1g", solvant:"Glucosé 5%", charge:{schema:"2g dans 50mL sur 30min"}, entretien:{rythme:"Perfusion continue", intervalle:"", doses:"", volume:"", perfusion:"", stabilite:""} },
      "Ertapénème":               { dosages:"1g", solvant:"Glucosé 5%", charge:{schema:"2g dans 100mL sur 30min"}, entretien:{rythme:"Perfusion intermittente", intervalle:"", doses:"", volume:"", perfusion:"", stabilite:""} },
      "Imipénème + Relebactam":   { dosages:"0,5g+0,25g", solvant:"Glucosé 5%", charge:{schema:"2g dans 500mL sur 60min"}, entretien:{rythme:"Perfusion intermittente", intervalle:"", doses:"", volume:"", perfusion:"", stabilite:""} },
      "Méropénème + Vaborbactam": { dosages:"1g/1g", solvant:"Glucosé 5%", charge:{schema:"2g dans 50mL sur 30min"}, entretien:{rythme:"Perfusion intermittente", intervalle:"", doses:"", volume:"", perfusion:"", stabilite:""} },
      "Aztréonam":                { dosages:"1g", solvant:"Glucosé 5%", charge:{schema:"2g dans 100mL sur 30min"}, entretien:{rythme:"Perfusion continue", intervalle:"", doses:"", volume:"", perfusion:"", stabilite:""} },
      "Témocilline":              { dosages:"1g ou 2g", solvant:"Glucosé 5%", charge:{schema:"2g dans 50mL sur 30min"}, entretien:{rythme:"Perfusion continue", intervalle:"", doses:"", volume:"", perfusion:"", stabilite:""} }
    },
