...
function recoCasParticuliers(p){
  ...
  $app.innerHTML = `
    <div class="card"><strong>Infections neuro-méningées</strong></div>
    <div class="hero-pneu card"><img src="./img/neuro.png" alt="Neuro" class="form-hero"></div>
    <div class="card">
      <p>Formulaire en cours…</p>
